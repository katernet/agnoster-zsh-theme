...
PROMPT_DIR=y					# Dir opts - trim: Trim pwd path c: Current dir y: Full path (Trim dependency 
...
#PROMPT_DOCKER=y				# [Depedency] Docker module
...
RPROMPT_GITVCS=y				# Right prompt git vcs module
